...
def main():
    ...
    if st.session_state.samples:
        custom_pages["Analysis Tools"].append(
            st.Page(
                "interface/sample_metadata.py",
                title="Sample Metadata Editor",
    ...
    st.divider()
    st.caption(
        f"[fla-analysis v {__VERSION__}{': ' + __COMMENT__ if __COMMENT__ else ''}](https://github.com/ericksamera/fla-analysis) | Developed by Erick Samera ([@ericksamera](https://github.com/ericksamera))"
    )
